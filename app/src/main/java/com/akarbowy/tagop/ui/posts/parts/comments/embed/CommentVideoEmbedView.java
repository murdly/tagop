...
public class CommentVideoEmbedView extends FrameLayout {

    @BindView(R.id.drawee_embed_image) SimpleDraweeView imageView;
    @BindView(R.id.video_play_frame) FrameLayout playFrame;

    public CommentVideoEmbedView(Context context) {
        super(context);
        init(context);
    }

    public void init(Context context) {
        ButterKnife.bind(this, inflate(context, R.layout.item_comment_embed_video, this));
